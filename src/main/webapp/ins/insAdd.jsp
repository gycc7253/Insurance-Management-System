...
<body>
	<div id = "content">
		<div id = "addBox">
			<form action="/insController/add.do" method = "post">
			<table id = "addTable">
				<tr>
					<td>
						Name
				...
				<tr>
					...
					<td>
						<input type = "text" name = "idcard" placeholder="Please enter the value"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type = "text" name = "bankcard" placeholder="Please enter the value"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type = "text" name = "pid" placeholder="Please enter the value"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type = "text" name = "isMarry" placeholder="Please enter the value"/>
					</td>
				</tr>
				<tr>
					<td>
