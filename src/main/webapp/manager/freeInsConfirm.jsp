					...
					<tr>
						...
						<td>
							<div id = "deleteButton" class = "toolButton" title = "delete">
								<a href = "<%=path %>/managerController/rejectFreeInsByManager.do?id=${freeIns.id }">X</a>
							</div>
							<div id = "submitButton" class = "toolButton" title = "submit">
								<a href = "<%=path %>/managerController/submitFreeInsByManager.do?id=${freeIns.id }">^</a>
							</div>
						</td>
					</tr>
				</c:forEach>
				...
				<tr>
					<td colspan="11">
						<c:if test="${pb.currentPage != 1 }">
							...
							<a href = "<%=path %>/managerController/getFreeInsByPageAndStatus.do?currentPage=1">First Page &emsp;</a>
							<a href = "<%=path %>/managerController/getFreeInsByPageAndStatus.do?currentPage=${pb.currentPage-1 }">Previous Page &emsp;</a>
						...
						<c:if test="${pb.currentPage != pb.totalPages }">
							...
							<a href = "<%=path %>/managerController/getFreeInsByPageAndStatus.do?currentPage=${pb.currentPage+1 }">Next Page &emsp;</a>
							<a href = "<%=path %>/managerController/getFreeInsByPageAndStatus.do?currentPage=${pb.totalPages }">Last Page &emsp;</a>
						</c:if>
